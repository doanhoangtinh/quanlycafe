 ...
 * @author ASUS
 */
public class ThemDM extends javax.swing.JDialog {

    /**
     * Creates new form NewJDialog
     */
    public ThemDM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        ...
        DanhMuc danhMuc = new DanhMuc(txtMaDM.getText(), txtTenDM.getText());
            ...
            if(res == JOptionPane.YES_OPTION){
                new DBConnection().addDanhMuc(danhMuc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemDM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemDM dialog = new ThemDM(new javax.swing.JFrame(), true);
