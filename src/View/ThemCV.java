 ...
 * @author ASUS
 */
public class ThemCV extends javax.swing.JDialog {
    /**
     * Creates new form NewJDialog
     */
    public ThemCV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        // TODO add your handling code here:
            ...
            if(res == JOptionPane.YES_OPTION){
                new DBConnection().addChucVu(chucVu);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemCV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemCV dialog = new ThemCV(new javax.swing.JFrame(), true);
